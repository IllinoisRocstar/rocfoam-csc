...
RHOCENTRAL_CLASS::RHOCENTRAL_CLASS() : FOAM_CLASS(),
                posPtr(NULL), negPtr(NULL), amaxSfPtr(NULL),
                pThermoPtr(NULL), fluxScheme(""), inviscid(false)
{}

RHOCENTRAL_CLASS::RHOCENTRAL_CLASS(int argc,char *argv[]) : FOAM_CLASS(), 
                posPtr(NULL), negPtr(NULL), amaxSfPtr(NULL),
                pThermoPtr(NULL), fluxScheme(""), inviscid(false)
{
