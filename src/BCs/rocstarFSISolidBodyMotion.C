...
\*---------------------------------------------------------------------------*/
//taken from "solidBodyMotionDisplacementPointPatchVectorField.H"

#include "rocstarFSISolidBodyMotion.H"
...
solidBodyMotionDisplacementPointPatchVectorFieldFSI::
solidBodyMotionDisplacementPointPatchVectorFieldFSI
(
    const pointPatch& p,
...
solidBodyMotionDisplacementPointPatchVectorFieldFSI
(
    const solidBodyMotionDisplacementPointPatchVectorFieldFSI& ptf,
    const pointPatch& p,
    const DimensionedField<vector, pointMesh>& iF,
...
const pointField&
solidBodyMotionDisplacementPointPatchVectorFieldFSI::localPoints0() const
{
    if (!localPoints0Ptr_)
    {
...
void solidBodyMotionDisplacementPointPatchVectorFieldFSI::updateCoeffs()
{
    if (this->updated())
    {
        return;
