...
FOAM_CLASS::FOAM_CLASS() :
                  argsPtr(NULL), runTimePtr(NULL),
                  listOptions(false), LTS(false), adjustTimeStep(false),
                  maxCo(0.0), maxDeltaT(0.0), CoNum(0.0), meanCoNum(0.0),
                  pPtr(NULL), TPtr(NULL), psiPtr(NULL), ePtr(NULL), rhoPtr(NULL),
                  UPtr(NULL), rhoUPtr(NULL), rhoEPtr(NULL), phiPtr(NULL),
                  meshPtr(NULL), turbulencePtr(NULL), trDeltaT(NULL)
{}
...
int FOAM_CLASS::PostProcess(int argc,char *argv[])
{
...
int FOAM_CLASS::addRegionOption()
{
...
int FOAM_CLASS::addFunctionObjectOptions()
{
...
int FOAM_CLASS::setRootCaseLists()
{
...
int FOAM_CLASS::listOptions_Func()
{
...
int FOAM_CLASS::createTimeControls()
{
...
int FOAM_CLASS::createDynamicFvMesh()
{
    Foam::Time &runTime(*runTimePtr);
